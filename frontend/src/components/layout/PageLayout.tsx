...
export default function PageLayout({ children }: { children?: React.ReactNode }) {
  return (
    <div className="page-shell pb-6">
      ...
      <footer className="pointer-events-none fixed bottom-1.5 left-1/2 z-20 -translate-x-1/2 py-0 text-center text-sm leading-none tracking-normal text-gray-800">
