...
export default function PageLayout({ children }: { children?: React.ReactNode }) {
  return (
    <div className="page-shell pb-2">
      ...
      <footer className="pointer-events-none fixed bottom-0.7 left-1/2 z-20 -translate-x-1/2 py-0 text-center leading-none tracking-normal text-gray-800 text-[12px]">
