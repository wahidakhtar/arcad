...
def upgrade() -> None:
    op.execute(
        ...
        BEGIN
            ...
            SELECT id INTO executed_badge_id FROM schema_core.badges WHERE key = 'exct';
            ...
            LOOP
                IF to_regclass(schema_name || '.badge_transitions') IS NOT NULL THEN
                    ...
                    USING transaction_type_id, requested_badge_id, executed_badge_id;
                END IF;
            END LOOP;
        END $$;
        """
