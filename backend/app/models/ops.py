...
class FEAssignment(Base):
    ...
    bucket_id: Mapped[int] = mapped_column(ForeignKey("schema_core.job_buckets.id"), nullable=False)
    fe_id: Mapped[int] = mapped_column(ForeignKey("schema_hr.users.id"), nullable=False)
