...
class MCSubproject(Base):
    __tablename__ = "subprojects"
    __table_args__ = {"schema": "schema_mc"}
...
class MCSite(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    subproject_id: Mapped[int] = mapped_column(ForeignKey("schema_mc.subprojects.id"), nullable=False)
