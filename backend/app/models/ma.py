...
class MASubproject(Base):
    __tablename__ = "subprojects"
    __table_args__ = {"schema": "schema_ma"}
...
class MASite(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    subproject_id: Mapped[int] = mapped_column(ForeignKey("schema_ma.subprojects.id"), nullable=False)
    ...
    mpaint: Optional[Mapped[bool]] = mapped_column(Boolean)
    mnbr: Optional[Mapped[bool]] = mapped_column(Boolean)
    arr: Optional[Mapped[bool]] = mapped_column(Boolean)
