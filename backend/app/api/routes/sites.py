...
def assign(project_key: str, site_id: int, payload: FEAssignmentRequest, user: UserContext = Depends(permission_required("request", "write")), db: Session = Depends(get_db)):
...
def remove_assignment(project_key: str, site_id: int, assignment_id: int, payload: FERemovalRequest, user: UserContext = Depends(permission_required("request", "write")), db: Session = Depends(get_db)):
...
def remove_fe(project_key: str, site_id: int, fe_id: int, bucket_id: int, payload: FERemovalRequest, user: UserContext = Depends(permission_required("request", "write")), db: Session = Depends(get_db)):
