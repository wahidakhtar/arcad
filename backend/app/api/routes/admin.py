...
@router.get("/badges", dependencies=[Depends(permission_required("site", "read"))])
def list_badges(db: Session = Depends(get_db)):
    return admin_service.list_badges(db)


@router.patch("/badges/{badge_id}", dependencies=[Depends(permission_required("site", "write"))])
...
@router.get("/badge-transitions", dependencies=[Depends(permission_required("site", "read"))])
def list_badge_transitions(db: Session = Depends(get_db)):
    return admin_service.list_badge_transitions(db)


@router.post("/badge-transitions", dependencies=[Depends(permission_required("site", "write"))])
...
@router.delete("/badge-transitions/{project}/{transition_id}", dependencies=[Depends(permission_required("site", "write"))])
...
@router.get("/ui-fields", dependencies=[Depends(permission_required("field", "read"))])
def list_ui_fields(db: Session = Depends(get_db)):
    return admin_service.list_ui_fields(db)


@router.patch("/ui-fields/{project}/{field_id}", dependencies=[Depends(permission_required("field", "write"))])
...
@router.post("/ui-fields/{project}/reorder", dependencies=[Depends(permission_required("field", "write"))])
...
@router.get("/jobs", dependencies=[Depends(permission_required("site", "read"))])
def list_jobs(db: Session = Depends(get_db)):
    return admin_service.list_jobs(db)


@router.patch("/jobs/{job_id}", dependencies=[Depends(permission_required("site", "write"))])
...
@router.get("/role-tags", dependencies=[Depends(permission_required("role", "read"))])
def list_role_tags(db: Session = Depends(get_db)):
    return admin_service.list_role_tags(db)


@router.patch("/role-tags", dependencies=[Depends(permission_required("role", "write"))])
